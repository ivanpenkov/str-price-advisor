...
| :--- | :--- | :--- | :--- |
| **Booking.com** | [Share-2VnNai](https://www.booking.com/Share-2VnNai)<br>*(Slug: `hotel/us/villa-del-sol-amazing-house-by-kivoya.html`)* | Headless Playwright + DOM / JSON-LD / API | Mandatory NordVPN Chicago (`feeder-chi`) |
| **Airbnb** | [Room 573857947793833342](https://www.airbnb.com/rooms/573857947793833342) | Headless Playwright + GraphQL / PDP JSON | Mandatory NordVPN San Francisco (`feeder-sf`) |
...
- **Stealth Integration**: All requests to Airbnb, VRBO, and Booking.com must route through the `StealthConnectionManager` and clean US NordVPN SOCKS5 proxy pool (`feeder-sf`, `feeder-dal`, `feeder-chi`). Nodes with AFRINIC/non-US allocations are strictly excluded.
